...
def apply_filter(data):
    ...
    for item, value in data['input'].items():
        print('\nprocessing...'+item)
        data['lt'][str(item)] = ps.filters.local_thickness(value, sizes=100, mode='dt')
        print('done')
...
def plot(outfolder, data):
    ...
    itemlist2 = [[['0-lz', '4-lz', '8-lz', '12-lz', '16-lz', '20-lz'], ['0-nz', '4-nz', '8-nz', '12-nz', '16-nz', '20-nz']]]
                # [['0-lx', '4-lx', '8-lx', '12-lx', '16-lx', '20-lx'], ['0-nx', '4-nx', '8-nx', '12-nx', '16-nx', '20-nx']],
                #  [[['0-ly', '4-ly', '8-ly', '12-ly', '16-ly', '20-ly'], ['0-ny', '4-ny', '8-ny', '12-ny', '16-ny', '20-ny']],['0-lz', '4-lz', '8-lz', '12-lz', '16-lz', '20-lz'], ['0-nz', '4-nz', '8-nz', '12-nz', '16-nz', '20-nz']]]
    # for i in itemlist1:
    #     for j in i:
    #         plt.figure()
